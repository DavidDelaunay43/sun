...
def convert_abc_to_gpu_cache(alembic_file_path: str, output_directory: str) -> None:
    ...
    gpu_cache_cmd: str = f'gpuCache -startTime {start_frame} -endTime {end_frame} -optimize -optimizationThreshold 40000 -dataFormat ogawa -useBaseTessellation -directory "{output_directory}" -fileName "{mesh}" {mesh};'
